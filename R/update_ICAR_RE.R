...
#' Simulate iCAR Random Effects \code{W2} Using Gibbs Sampling for Indicator Models
#'
...
#'
#' # Simulate W2 for a specific node index
#' simulated_W2 <- W2_sim_Gibbs_componentwise_thr_ind(1, W2, mean_mu_latent, kappa_w2, kappa_mu, nbd_info, no_of_nbd)

W2_sim_Gibbs_componentwise_thr_ind <- function(node_index,
                                               W2,
                                               mean_mu_latent,
                                               kappa_w2,
                                               kappa_mu,
